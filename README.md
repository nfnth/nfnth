...
|Content|Includes||
|-|-|-|
|source|· [⚙⚙](https://xn--x7ha.ws) OS, an Arch-based, *Firefox-only* distro<br/>· code to [mattdown.com](https://mattdown.com) [📚📚](https://xn--zt8ha.ws) *docs-based* app|available [here](https://xn--x7ha.ws), also on [https://github.com/nfnth/os](https://github.com/nfnth/os)|
...
|physical|· paperback copy of **Civilian Complex** [♠♠](https://xn--b6ha.ws)<br/>· *$1* Native American 2021 coin|available [here](https://civilplex.com)|
