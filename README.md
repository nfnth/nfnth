...
|guide *electronic*|· [Arch Linux](https://archlinux.org/)-based *Firefox-only* distro<br/>· access to site content and code|download [⚙⚙ ISO](https://xn--x7ha.ws) and/or view on [GitHub](https://github.com/nfnth/os)|
|guide *paperback*|· copy of [Civilian Complex]() [♠♠](http://xn--b6ha.ws)<br/>· *$1* Native American 2021 coin|purchase on [Stripe](https://buy.stripe.com/5kA4hL5NB6Qv7Ty5kk)|
