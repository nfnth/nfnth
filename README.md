...
Hold <img src="img/opensea.png" style="width:40px;height:40px;" /> [**OpenSea** deed domain](https://opensea.io/urland) to keep virtual space.
...
To shop items, go to [**nfnth**.com](https://nfnth.com) and select <img src="res/img/leaf/leaf2.png" style="width:40px;height:40px;" /> (*top-right*)
