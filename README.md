...
|intellectual|· an [Arch Linux](https://archlinux.org/)-based *Firefox-only* distro<br/>· exclusive access to [mattdown.com](https://mattdown.com) [📚📚](https://xn--zt8ha.ws) docs-based code<br/>· digital copies of all deed domain assets|download [⚙⚙ ISO](https://xn--x7ha.ws) and/or view on [GitHub](https://github.com/nfnth/os)|
