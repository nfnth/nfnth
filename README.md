...
|intellectual|· an [Arch Linux](https://archlinux.org/)-based *Firefox-only* distro<br/>· access to [mattdown.com](https://mattdown.com) [📚📚](https://xn--zt8ha.ws) docs-based source<br/>· digital copies of each **deed domain**|download [⚙⚙ ISO](https://xn--x7ha.ws) and/or view on [GitHub](https://github.com/nfnth/os)|
