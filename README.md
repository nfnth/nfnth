...
|intellectual|· an [Arch Linux](https://archlinux.org/)-based *Firefox-only* distro<br/>· access to [mattdown.com](https://mattdown.com) [📚📚](https://xn--zt8ha.ws) docs-based site code<br/>· digital copy of deed domain assets|download [⚙⚙ ISO](https://xn--x7ha.ws) and/or view on [GitHub](https://github.com/nfnth/os)|
