...
|source code|· an [Arch Linux](https://archlinux.org/)-based *Firefox-only* distro<br/>· access to [mattdown.com](https://mattdown.com) [📚📚](https://xn--zt8ha.ws) docs-based source|· download [⚙⚙ ISO](https://xn--x7ha.ws)<br/>· view on [GitHub](https://github.com/nfnth/os)|
