...
|electronic copy|- **10.OS** ISO<br/>- access to technical stack|available to [download](https://github.com/nfnth/os) and/or on [GitHub](https://github.com/nfnth/os)|
|physical copy|- **Civilian Complex** · NfNth's Guide to Deed Domain *paperback*<br/>- **Native American** 2021 $1 Coin|available on [Stripe](https://buy.stripe.com/5kA4hL5NB6Qv7Ty5kk)|
