...
var cardCode = '<div class="flip-card cardy"><div class="flip-card-inner z-depth-1" style="cursor:pointer;border-radius:12px;"><div class="flip-card-front" onclick="flipCard();" style="z-index:1;border-radius:12px;border:solid 1px YYYY!important;"><img  src="XXXX" style="width:48px;height:48px;opacity:0.5;"><img src="res/img/seal3.png" style="width:24px;height:24px;" /></div><div class="flip-card-back" style="transform: rotateY(180deg);border-radius:12px;"><div id="tactb" style="opacity:0.75; display: flex; flex-direction:column; align-items: center;position: absolute;top: 4px;left: 4px;"><span id="tact1" style="font-size: 24px;font-weight: bold;"></span><img style="cursor:pointer;" id="tacta" width="16" height="16" /></div><div></div><div id="tact2" style="opacity:0.75; display: flex; flex-direction:column; align-items: center;position: absolute;bottom: 4px;right: 4px;-webkit-transform: rotateX(180deg); transform: rotateX(180deg);"></div></div></div>';
