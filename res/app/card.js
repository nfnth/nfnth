...
function flipCard() { var mySuit = Math.floor(Math.random() * (4 - 1 + 1)); var myNum = Math.floor(Math.random() * (13 - 1 + 1)); 
	$("#tacta").attr("src","res/img/card/" + suit[mySuit] + ".png");$("#tact1").html(num[myNum]);
		     $("#tactb").attr("src","res/img/card/" + suit[mySuit] + ".png");$("#tact2").html(num[myNum]);
		     if (mySuit > 1) { $("#tact1").css("color","black"); $("#tact2").css("color","black");  } else { $("#tact1").css("color","red"); $("#tact2").css("color","red"); } 
