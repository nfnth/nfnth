...
function showMail() { if (tempMark != "") { tempMark.remove(); tempMark = ""; }
	...
	tempMark.setPopup(new AnimatedPopup({ offset: 25, openingAnimation: {duration: 1000, easing: 'easeOutElastic'}, closingAnimation: { duration: 200, easing: 'easeInBack' } }).setHTML(mailContent)); 
