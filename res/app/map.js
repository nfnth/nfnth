...
var learnOwn = [-100.19697959674477, 40.77108807140884];
...
function showIntro() {
	...
	var markup = '<div><div style="display:flex; justify-content:center;"><img style="cursor:pointer;" onclick="tempDoc(\'README.md\');" width="48" height="48" src="res/img/seal3.png"/></div><div style="margin-top:16px; font-size:16px;"><a onclick="showOwnLearn();">UR.Land</a><br/><br/><a class="waves-effect waves-blue btn amber lighten-2" onclick="showIntroArt();"><i class="material-icons">arrow_forward</i></a></div></div>';
...
function showIntroArt() { startPoint = base; endPoint = learnArt; showPath('green');
	...
	var style = $('#markerb').attr('style'); style += ";background-color:green;border:solid 2px black;"; $('#markerb').attr('style',style);
    	//style += ";background-image:url('img/icon/domain/"+folder + "/" +icon+".png'); 
	var markup = '<div><div style="display:flex; justify-content:center;"><img style="cursor:pointer;" onclick="tempDoc(\'README.md\');" width="48" height="48" src="res/img/barrel.png"/></div><div style="margin-top:16px; font-size:16px;"><a onclick="showOwnLearn();">Fort</a><br/><br/><a class="waves-effect waves-blue btn amber lighten-2" onclick="showIntroOwn();"><i class="material-icons">arrow_forward</i></a></div></div>';
...
var editContent = '<div id="header-logo" style="display: flex;justify-content: space-evenly;align-items: center; display: flex;margin-top:12px;"><div style="display:flex; justify-content:center;"><div class="input-field col s4"><input id="datetime-text" type="text" class="validate" onchange="setDateTime();"></div><div id="editDT" class="chip z-depth-1 waves-effect waves-light blue lighten-1" style="display:flex; color:white; align-items:center; justify-content:center; width:60px;" onclick="dtStart();"><div style="display:flex;"><i id="pal" class="material-icons">gps_fixed</i></div></div></div><div style="border-radius:12px; padding:12px;" class="z-depth-1 input-field col s6"><img width="48" height="48" id="thumb" src="res/img/barrel.png" onclick="$(\'#preview\').trigger(\'click\');" /></div><div style="display:flex;"><div style="display:flex; flex-direction:column;"><div id="editLoc" class="chip z-depth-1 waves-effect waves-light blue lighten-1" style="display:flex; color:white; align-items:center; justify-content:center; width:60px;" onclick="locStart();"><div style="display:flex;"><i id="pal" class="material-icons">place</i></div></div><div id="editLoc" class="chip z-depth-1 waves-effect waves-light grey lighten-1" style="display:flex; color:white; align-items:center; justify-content:center; width:60px;" onclick="gpsStart();"><div style="display:flex;"><i id="pal" class="material-icons">gps_fixed</i></div></div></div><div style="display:flex; flex-direction:column;"><div id="editColor" class="chip z-depth-1 waves-effect waves-light grey lighten-1" style="display:flex; color:white; align-items:center; justify-content:center; width:60px;" onclick="colorStart();"><div style="display:flex;"><i id="pal" class="material-icons">palette</i></div></div><div id="editText" class="chip z-depth-1 waves-effect waves-light grey lighten-1" style="display:flex; color:white; align-items:center; justify-content:center; width:60px;" onclick="textStart();"><div style="display:flex;"><i id="pal" class="material-icons">edit</i></div></div></div></div></div><div style="display:flex; justify-content:center;"><div class="input-field col s4"><input id="edit-name" type="text" class="validate" onchange="setText();"><label for="edit-name">Artifact Name</label></div></div><div class="hiddenfile"><input name="upload" type="file" id="preview" onchange="setPreview();" multiple="multiple"/><div style="visibility:hidden;width:0;position:absolute;top:0;"><input type="color" oninput="setColor();" id="favcolor" name="favcolor" value="#ff0000" style="width:0px; height:0px;opacity:0;" /></div></div><div style="display:flex;justify-content:space-evenly;margin-top:12px;margin-bottom:12px;"><label style="display:flex; align-items: center; margin-right: 24px; margin-left: 12px;"><input type="checkbox" class="filled-in" /><span><i class="material-icons">account_balance_wallet</i></span></label><a class="waves-effect waves-light btn-flat green lighten-1" onclick="postDomain(true);"><i class="material-icons right">upload</i>Upload</a></div></div>';
