...
function showDomain(i) { 
	$.getJSON('https://en.wikipedia.org/w/api.php?origin=*&action=query&prop=coordinates&titles='+domains[i].name+'&coprimary=all&format=json', function(data) { dataString = data.toString(); alert(dataString);
