...
function showMark(coord, color, image, link, name) { 
	...
	var marv = document.createElement('div'); marv.id = 'marker' + i; $('#marker'+i).addClass('markre'); $('#marker'+i).addClass('z-depth-3'); 
	var style=$('#marker'+i).attr('style'); style += ";background-color:"+ color + ";border:solid 2px black;"; $('#marker'+i).attr('style',style); 
    	//style += ";background-image:url('img/icon/domain/"+folder + "/" +icon+".png'); 
