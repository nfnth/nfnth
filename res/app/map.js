...
function showMark(coord, color, image, link, name, id, area) { 
	...
	switch(area) {
		...
		case 'domain': 
			...
			custom = '<a style="color:beige;" class="waves-effect waves-blue btn amber lighten-4" onclick="buildWallet(' + id + ');" ><i class="material-icons">account_balance_wallet</i></a>&nbsp;&nbsp;<a class="modal-trigger waves-effect waves-light btn blue lighten-2" href="#modal1" onclick="addListDetail(' + id + ');"><i class="material-icons">assignment</i></a>'; break;
		case 'artifact': 
