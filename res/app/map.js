...
var editContent = '<div class="editMark" style="width:100%; height:48px;display:flex;"><a class="quick" style="display: flex;justify-content: center;align-items: center;border-right:solid 1px dimgrey;"class="crisp waves-effect waves-light blue btn" onclick="setShape();"><i class="material-icons" id="shape-icon">circle</i></a><a class="quick" style="border-left:solid 1px dimgrey;border-right:solid 1px green;left:-1px; display: flex;justify-content: center;align-items: center;"class="crisp waves-effect waves-light blue btn" onclick="switchIcon();"><i class="material-icons">emoji_objects</i></a><a class="quick" style="border-left:solid 1px dimgrey;border-right:solid 1px dimgrey;left:-1px;display: flex;justify-content: center;align-items: center;"class="crisp waves-effect waves-light blue btn" onclick="colorStart(this);">🎨</a><a class="quick" style="border-left:solid 1px dimgrey;display: flex;justify-content: center;align-items: center;left:-1px;"class="crisp waves-effect waves-light blue btn" onclick="outlineStart(this);"><i class="material-icons">gradient</i></a></div><div id="header-logo" style="display: flex;justify-content: space-evenly;align-items: center; display: flex;margin-top:8px;"><div style="border-radius:12px; padding:12px;" class="z-depth-1"><img width="48" height="48" id="thumb" src="res/img/barrel.png" onclick="$(\'#preview\').trigger(\'click\');" /></div></div></div></div><div class="hiddenfile"><input name="upload" type="file" id="preview" onchange="setPreview();" multiple="multiple"/><div style="visibility:hidden;width:0;position:absolute;top:0;"><input type="color" oninput="setColor();" id="favcolor" name="favcolor" value="#ff0000" style="width:0px; height:0px;opacity:0;" /><input type="color" oninput="setOutline();" id="favcolor2" name="favcolor2" value="#ff0000" style="width:0px; height:0px;opacity:0;" /></div></div><div style="padding:12px; padding-bottom:0px; display:flex; justify-content:center;"><div style="margin-top:0px;margin-bottom:0px;" class="input-field col s4"><input id="edit-name" type="text" class="validate" onchange="setText();"></div></div><div style="display:flex;justify-content:space-evenly;margin-top:12px;margin-bottom:12px;align-items:center;"><a class="waves-effect waves-light btn-flat" onclick="resetArea();"><i class="material-icons">refresh</i></a><a class="waves-effect waves-green green btn" onclick="showView(\'editor\');"><i class="material-icons right">arrow_forward</i>Editor</a></div></div>';
