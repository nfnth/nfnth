...
var hist = true;
function showHist() { if (hist) {hist = false; $("#set-2").removeClass("quicker"); } else {hist = true; $("#set-2").addClass("quicker");} }
