...
function addOpen(i){ var extra = ""; if(opens[i].checked == true) { extra = "checked='checked'"; } 
	if (showGridOpen) {
    		$("#registry-open").append("<a class='collection-item open' style='padding-right:8px;'><div style='display:flex;justify-content:space-between;align-items:center;'><div><img style='display:flex; cursor:pointer;' onclick='checkOpenDeed(" + i + ");' class='z-depth-1' width='48' height='48' src='res/img/key/" + getCollect(opens[i].core.slug) + "'/></div>&nbsp;&nbsp;<div style='display:flex;align-items:center;'><div style='display:flex;cursor:pointer;'><div onclick='addOpenDeed(" + i + ");' style='cursor:pointer; font-size: 14px;margin-bottom:0px;' class='z-depth-1 chip collected hoverable'>" + opens[i].core.slug + "&nbsp;·&nbsp;<span style='font-weight:bold;font-size:13px;'>" + opens[i].count + "</span></div></div>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<div><label><input type='checkbox' " + extra + " id='check" + i + "' onclick='setOpen(" + i + ");' /><span>&nbsp;</span></label></div></div></div></a>");  } else {
