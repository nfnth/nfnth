...
function addList(i){ var extra = ""; if(domains[i].checked == true) { extra = "checked='checked'"; } var filler = "";
	...
	if (showListOpen) {
		...
		$("#registry-domain").append("<a class='collection-item' style='padding-right:8px;'><div style='display:flex;justify-content:space-between;'><div style='display:flex;'><img style='cursor:pointer;' onclick='flyMark(" + i + ");' class='z-depth-1' width='52' height='30' src='" + domains[i].core.image_url + "'/></div><div style='display:flex; justify-content:space-between;align-items:center;'><span style='font-size: 18px;padding: 10px;display: flex;align-items: center;background-color:blanchedalmond!important; color:" + filler + " btn waves-effect waves-light lighten-4' onclick='buildLand(" + i + ");'>📜</span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<div style='display:flex; flex-direction:column;'><label style='display:flex;'><input type='checkbox' " + extra + " onclick='setList(" + i + ");' /><span></span></label></div></div></div></a>"); } }
